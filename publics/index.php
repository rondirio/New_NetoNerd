...
<body>
    ...
    <div class="produto-card">
        <div class="produto-header">
            <div class="produto-icon">
                <i class="fas fa-wallet fa-3x" style="color: #059669;"></i>
            </div>
            <div class="produto-tagline">Gestão Financeira Transparente</div>
        </div>
        <div class="produto-body">
            <h4 class="mb-2">Despesas</h4>
            <p class="produto-descricao">
                <strong>Registro de despesas e acompanhamento financeiro</strong> completo. Organize suas contas, visualize gráficos de gastos e tenha controle total do seu dinheiro.
            </p>
            <ul class="list-unstyled mb-3">
                <li><i class="fas fa-check text-success"></i> Categorização de gastos</li>
                <li><i class="fas fa-check text-success"></i> Gráficos de desempenho</li>
                <li><i class="fas fa-check text-success"></i> Exportação de dados</li>
                <li><i class="fas fa-check text-success"></i> Código aberto e seguro</li>
            </ul>
            <div class="produto-preco">
                <div class="preco-destaque" style="color: #059669;">
   ...
   <?php include(__DIR__ . '/../routes/footer.php');?>
