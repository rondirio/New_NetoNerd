...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Crect width='32' height='32' rx='6' fill='%23007bff'/%3E%3Ctext x='50%25' y='50%25' dominant-baseline='central' text-anchor='middle' font-family='Arial Black,Arial,sans-serif' font-weight='900' font-size='14' fill='white'%3ENN%3C/text%3E%3C/svg%3E">
    ...
    <div class="nn-header-container">
        ...
        <nav class="nn-header-nav" id="headerNav">
            <?php if ($tipo_usuario === 'admin'): ?>
                ...
                <a href="gerar_ordem_servico.php" class="<?= $pagina_atual === 'gerar_ordem_de_servico.php' ? 'active' : '' ?>">
                    <i class="fas fa-dashboard"></i>
                    <span class="nn-hidden-mobile">OS</span>
                </a>
                <a href="atribuir_chamados.php" class="<?= $pagina_atual === 'atribuir_chamados.php' ? 'active' : '' ?>">
                ...
                <a href="chamados_ativos.php" class="<?= $pagina_atual === 'chamados_ativos.php' ? 'active' : '' ?>">
                    <i class="fas fa-list"></i>
                    <span>Todos Chamados</span>
                </a>
                <a href="apresenta_tecnicos.php" class="<?= $pagina_atual === 'apresenta_tecnicos.php' ? 'active' : '' ?>">
                ...
                <a href="api_keys.php" class="<?= $pagina_atual === 'licencas.php' ? 'active' : '' ?>">
            ...
            <?php elseif ($tipo_usuario === 'tecnico'): ?>
                <!-- Menu Técnico -->
                <a href="paineltecnico.php" class="<?= $pagina_atual === 'paineltecnico.php' ? 'active' : '' ?>">
                    <i class="fas fa-dashboard"></i>
                    <span class="nn-hidden-mobile">Dashboard</span>
                </a>
                <a href="meus_chamados.php" class="<?= $pagina_atual === 'meus_chamados.php' ? 'active' : '' ?>">
            ...
            <?php else: ?>
                <!-- Menu Cliente -->
                <a href="home.php" class="<?= $pagina_atual === 'home.php' ? 'active' : '' ?>">
                ...
                <a href="abrir_chamado.php" class="<?= $pagina_atual === 'abrir_chamado.php' ? 'active' : '' ?>">
